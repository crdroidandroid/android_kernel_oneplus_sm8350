...
//	define					
//**************************
#define 	ONE_MSEC_COUNT	18			// 18.0288kHz * 18 \81\E0 1ms
...
UINT8 GetGyroOffset124( UINT16* GyroOffsetX, UINT16* GyroOffsetY, INT16 GYROF_UPPER, INT16 GYROF_LOWER   )
{
	...
	// EP1\82ł͔\BD\93]\8F\88\97\9D\82\B5\82Ȃ\A2\81B
...
//	SetTransDataAdr124( SinWave_OutAddr	,	(UINT32)SinWave_Output ) ;		// \8F\89\8A\FA\92l\82̏o\97͐\E6\83A\83h\83\8C\83X\82́A\8E\A9\95\AA\82̃\81\83\93\83o
...
//	SetTransDataAdr124( CosWave_OutAddr	,	(UINT32)CosWave_Output );		// \8F\89\8A\FA\92l\82̏o\97͐\E6\83A\83h\83\8C\83X\82́A\8E\A9\95\AA\82̃\81\83\93\83o
...
//TRACE(" lvl = %08x \n", (unsigned int)UlActChkLvl  ) ;
	...
	MesFil124( NOISE ) ;					// \91\AA\92\E8\97p\83t\83B\83\8B\83^\81[\82\F0\90ݒ肷\82\E9\81B
...
// #define		GEA_DIF_HIG		0x0062			// 2021_32.8lsb/\81\8B/s    max 3.0\81\8B/s-p-p
 #define		GEA_DIF_HIG		0x0057			// 2030_87.5lsb/\81\8B/s    max 1.0\81\8B/s-p-p
...
UINT8	RunGea124( void )
{
	...
	MesFil124( THROUGH ) ;				// \91\AA\92\E8\97p\83t\83B\83\8B\83^\81[\82\F0\90ݒ肷\82\E9\81B
...
//TRACE("GY_AVEOFT = %08xh \n",(unsigned int)SlMeasureAveValueB) ;
		// X
		UsGxoVal[UcCnt] = (UINT16)( SlMeasureAveValueA >> 16 );	// \95\BD\8Bϒl\91\AA\92\E8
		
		// Y
		UsGyoVal[UcCnt] = (UINT16)( SlMeasureAveValueB >> 16 );	// \95\BD\8Bϒl\91\AA\92\E8
...
// level of judgement
#define		GEA_MAX_LVL		0x0A41			// 2030_87.5lsb/\81\8B/s    max 30\81\8B/s-p-p
#define		GEA_MIN_LVL		0x1482			// 2030_87.5lsb/\81\8B/s    min 60\81\8B/s-p-p
...
////////// ////////// ////////// ////////// //////////
	...
	RamWrite32A( CMD_GYRO_WR_ACCS , 0x1B180000 );		/* FS_SEL=3\8CŒ\E8 & Disable Self Test */
	UcStRd = 1;
	while( UcStRd ) {
		UcStRd = RdStatus124(1);
	}
...
////////// ////////// ////////// ////////// //////////
	...
	RamWrite32A( CMD_GYRO_WR_ACCS , 0x1BD80000 );		/* FS_SEL=3\8CŒ\E8 & Enable Self Test */
	UcStRd = 1;
	while( UcStRd ) {
		UcStRd = RdStatus124(1);
	}
...
//TRACE("UsGyrYval = %04x\n", UsGyrYval ) ;
	...
	RamWrite32A( CMD_GYRO_WR_ACCS , 0x1B000000 | ( UlGyroConfig >> 8));		/* \8C\B3\82̐ݒ\E8\92l\82ɖ߂\B7 */
	UcStRd = 1;
	while( UcStRd ) {
		UcStRd = RdStatus124(1);
	}
