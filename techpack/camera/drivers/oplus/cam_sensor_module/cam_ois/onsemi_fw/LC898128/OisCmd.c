...
TRACE("TnePtp\n") ;
	...
	SetSinWavGenInt();
	SetTransDataAdr( SinWave_OutAddr	,	SinWave_Output ) ;		// \8Fo\97͐\E6\83A\83h\83\8C\83X
	SetTransDataAdr( CosWave_OutAddr	,	CosWave_OutAddr );		// \8Fo\97͐\E6\83A\83h\83\8C\83X
...
UINT_32	TneCen( UINT_8 UcTneAxs, ADJ_HALL* ptr )
{
	...
	UcTofRst	= SUCCESS ;				/* \8Eb\92\E8\82\C5OK\82ɂ\B7\82\E9 */
...
//********************************************************************************
#if FS_MODE == 0
#define 	ONE_MSEC_COUNT	18			// 18.0446kHz * 18 \81\E0 1ms
#else //FS_MODE
#define 	ONE_MSEC_COUNT	15			// 15.0273kHz * 15 \81\E0 1ms
#endif //FS_MODE
...
#define		ZG_MRGN		(409 << 16)					// G tolerance  100mG\82Ƃ\B7\82\E9
UINT_32	MeasGyAcOffset(  void  )
{
	UINT_32	UlRsltSts;
	INT_32			SlMeasureParameterA , SlMeasureParameterB ;
...
// 	RamWrite32A( SinWave.Gain , 0x00000000 ) ;			// Gain\82͂\BB\82ꂼ\82\EA\90ݒ肷\82邱\82\C6
// 	RamWrite32A( CosWave.Gain , 0x00000000 ) ;			// Gain\82͂\BB\82ꂼ\82\EA\90ݒ肷\82邱\82\C6
void	SetSinWavePara( UINT_8 UcTableVal ,  UINT_8 UcMethodVal )
{
	...
	if( UcMethodVal == CIRCWAVE) {
		RamWrite32A( SinWave_Phase	,	0x00000000 ) ;		// \90\B3\8C\B7\94g\82̈ʑ\8A\97\CA
		RamWrite32A( CosWave_Phase 	,	0x20000000 );		// \90\B3\8C\B7\94g\82̈ʑ\8A\97\CA
	}else{
		RamWrite32A( SinWave_Phase	,	0x00000000 ) ;		// \90\B3\8C\B7\94g\82̈ʑ\8A\97\CA
		RamWrite32A( CosWave_Phase 	,	0x00000000 );		// \90\B3\8C\B7\94g\82̈ʑ\8A\97\CA
	}


	if( UlFreqDat == 0xFFFFFFFF )			/* Sine\94g\92\86\8E~ */
	{
		RamWrite32A( SinWave_Offset		,	0x00000000 ) ;									// \94\AD\90\B6\8E\FC\94g\90\94\82̃I\83t\83Z\83b\83g\82\F0\90ݒ\E8
		RamWrite32A( SinWave_Phase		,	0x00000000 ) ;									// \90\B3\8C\B7\94g\82̈ʑ\8A\97\CA
//		RamWrite32A( SinWave_Gain		,	0x00000000 ) ;									// \94\AD\90\B6\8E\FC\94g\90\94\82̃A\83b\83e\83l\81[\83^(\8F\89\8A\FA\92l\82\CD0[dB])
//		SetTransDataAdr( SinWave_OutAddr	,	 (UINT_32)SinWave_Output );			// \8Fo\97͐\E6\83A\83h\83\8C\83X

		RamWrite32A( CosWave_Offset		,	0x00000000 );									// \94\AD\90\B6\8E\FC\94g\90\94\82̃I\83t\83Z\83b\83g\82\F0\90ݒ\E8
		RamWrite32A( CosWave_Phase 		,	0x00000000 );									// \90\B3\8C\B7\94g\82̈ʑ\8A\97\CA
//		RamWrite32A( CosWave_Gain 		,	0x00000000 );									// \94\AD\90\B6\8E\FC\94g\90\94\82̃A\83b\83e\83l\81[\83^(\8F\89\8A\FA\92l\82\CDCut)
//		SetTransDataAdr( CosWave_OutAddr	,	 (UINT_32)CosWave_Output );			// \8Fo\97͐\E6\83A\83h\83\8C\83X

		RamWrite32A( SinWaveC_Regsiter	,	0x00000000 ) ;									// Sine Wave Stop
		SetTransDataAdr( SinWave_OutAddr	,	0x00000000 ) ;		// \8Fo\97͐\E6\83A\83h\83\8C\83X
		SetTransDataAdr( CosWave_OutAddr	,	0x00000000 );		// \8Fo\97͐\E6\83A\83h\83\8C\83X
		RamWrite32A( HALL_RAM_HXOFF1		,	0x00000000 ) ;				// DelayRam Clear
		RamWrite32A( HALL_RAM_HYOFF1		,	0x00000000 ) ;				// DelayRam Clear
	}
	else
	{
		RamWrite32A( SinWave_Offset		,	UlFreqDat ) ;									// \94\AD\90\B6\8E\FC\94g\90\94\82̃I\83t\83Z\83b\83g\82\F0\90ݒ\E8
		RamWrite32A( CosWave_Offset		,	UlFreqDat );									// \94\AD\90\B6\8E\FC\94g\90\94\82̃I\83t\83Z\83b\83g\82\F0\90ݒ\E8

		RamWrite32A( SinWaveC_Regsiter	,	0x00000001 ) ;									// Sine Wave Start
		SetTransDataAdr( SinWave_OutAddr	,	(UINT_32)HALL_RAM_HXOFF1 ) ;		// \8Fo\97͐\E6\83A\83h\83\8C\83X
		SetTransDataAdr( CosWave_OutAddr	,	 (UINT_32)HALL_RAM_HYOFF1 );		// \8Fo\97͐\E6\83A\83h\83\8C\83X
	...
	while( UcFin ) {
		if( UcFin & 0x01 ) {
			if( UlMinimumValueA >= abs(SlMeasureAveValueA) ) {
				UlMinimumValueA = abs(SlMeasureAveValueA) ;
				UsAdxMin = UsAdxOff ;
				// \8E\FB\91\A9\82𑁂߂邽\82߂ɁA\8Fo\97͒l\82ɔ\E4\97Ⴓ\82\B9\82\E9
...
void	SetSinWavGenInt( void )
{
	...
	RamWrite32A( SinWave_Offset		,	0x00000000 ) ;		// \94\AD\90\B6\8E\FC\94g\90\94\82̃I\83t\83Z\83b\83g\82\F0\90ݒ\E8
	RamWrite32A( SinWave_Phase		,	0x60000000 ) ;		// \90\B3\8C\B7\94g\82̈ʑ\8A\97\CA
	RamWrite32A( SinWave_Gain		,	0x00000000 ) ;		// \94\AD\90\B6\8E\FC\94g\90\94\82̃A\83b\83e\83l\81[\83^(\8F\89\8A\FA\92l\82\CD0[dB])
//	RamWrite32A( SinWave_Gain		,	0x7FFFFFFF ) ;		// \94\AD\90\B6\8E\FC\94g\90\94\82̃A\83b\83e\83l\81[\83^(\8F\89\8A\FA\92l\82\CDCut)
//	SetTransDataAdr( SinWave_OutAddr	,	(UINT_32)SinWave_Output ) ;		// \8F\89\8A\FA\92l\82̏o\97͐\E6\83A\83h\83\8C\83X\82́A\8E\A9\95\AA\82̃\81\83\93\83o

	RamWrite32A( CosWave_Offset		,	0x00000000 );		// \94\AD\90\B6\8E\FC\94g\90\94\82̃I\83t\83Z\83b\83g\82\F0\90ݒ\E8
	RamWrite32A( CosWave_Phase 		,	0x00000000 );		// \90\B3\8C\B7\94g\82̈ʑ\8A\97\CA
	RamWrite32A( CosWave_Gain 		,	0x00000000 );		// \94\AD\90\B6\8E\FC\94g\90\94\82̃A\83b\83e\83l\81[\83^(\8F\89\8A\FA\92l\82\CDCut)
//	RamWrite32A( CosWave_Gain 		,	0x7FFFFFFF );		// \94\AD\90\B6\8E\FC\94g\90\94\82̃A\83b\83e\83l\81[\83^(\8F\89\8A\FA\92l\82\CD0[dB])
//	SetTransDataAdr( CosWave_OutAddr	,	(UINT_32)CosWave_Output );		// \8F\89\8A\FA\92l\82̏o\97͐\E6\83A\83h\83\8C\83X\82́A\8E\A9\95\AA\82̃\81\83\93\83o
...
//------------------------------------------------------------------------------------------------
	...
	UcSndDat = (unsigned char)(UlRcvDat >> 24);								// \8FI\97\B9\83X\83e\81[\83^\83X

	// \96߂\E8\92l\82\F0\95ҏW
	...
	// \83L\83\83\83\8A\83u\83\8C\81[\83V\83\87\83\93\8C\E3\82̒l\82\F0\8E擾
...
// History			: First edition
//********************************************************************************
/*  bit7  	HX GYR			Hall X  \82Ɠ\AF\95\FB\8C\FC\82\CCGyro\90M\8D\86\82\AAGX?               0:GX  1:GY  */
/*  bit6  	HX GYR pol		Hall X+ \82Ɠ\AF\95\FB\8C\FC\82\CCGyro\90M\8D\86\82\AAX+\82\C6G+\82œ\AF\95\FB\8C\FC?   0:NEG 1:POS */
/*  bit5  	HY GYR pol		Hall Y+ \82Ɠ\AF\95\FB\8C\FC\82\CCGyro\90M\8D\86\82\AAY+\82\C6G+\82œ\AF\95\FB\8C\FC?   0:NEG 1:POS */
/*  bit4  	GZ pol			\8A\EE\96{\8Bɐ\AB\82ɑ΂\B5\82\C4GyroZ\90M\8D\86\82\AA\93\AF\95\FB\8C\FC?            0:NEG 1:POS */
/*  bit3  	HX ACL			Hall X  \82Ɠ\AF\95\FB\8C\FC\82\CCAccl\90M\8D\86\82\AAAX?               0:AX  1:AY  */
/*  bit2  	HX ACL pol		Hall X+ \82Ɠ\AF\95\FB\8C\FC\82\CCAccl\90M\8D\86\82\AAX+\82\C6A+\82œ\AF\95\FB\8C\FC?   0:NEG 1:POS */
/*  bit1  	HY ACL pol		Hall Y+ \82Ɠ\AF\95\FB\8C\FC\82\CCAccl\90M\8D\86\82\AAY+\82\C6A+\82œ\AF\95\FB\8C\FC?   0:NEG 1:POS */
/*  bit0  	AZ pol			\8A\EE\96{\8Bɐ\AB\82ɑ΂\B5\82\C4AcclZ\90M\8D\86\82\AA\93\AF\95\FB\8C\FC?            0:NEG 1:POS */
                      //   top0\81\8Bbtm0\81\8B//
