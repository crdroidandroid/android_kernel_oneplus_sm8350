...
/* input parameter  :                                                                    */
/* output parameter :                                                                    */
/* comment          : DFT\82̌W\90\94\94\AD\90\B6    			                                         */
/*                                                                            2018.01.18 */
/*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*/
...
void CoeffGenerate( double fc )
{
	...
	//***** \8E擾\82\B5\82\BD\8E\FC\94g\90\94\83e\81[\83u\83\8B\82\A9\82画\92\E8\83|\83C\83\93\83g\82Ɣ\BB\92\E8theta\82̎Z\8Fo *****
	df = fs / (double)N;									// FFT\82\CC1\83|\83C\83\93\83g\93\96\82\BD\82\E8\82̎\FC\94g\90\94
//	point = (int)(fc / df + 0.5);							// \94\BB\92\E8\83|\83C\83\93\83g\82̎Z\8Fo
//	theta = 2.0 * PAI * (double)point * df / fs;			// \94\BB\92\E8\83|\83C\83\93\83g\82ł̈ʑ\8A\82̎Z\8Fo
	point = (int)(fc / df + (float)5/(float)10);							// \94\BB\92\E8\83|\83C\83\93\83g\82̎Z\8Fo
	theta = (float)2 * PAI * (double)point * df / fs;			// \94\BB\92\E8\83|\83C\83\93\83g\82ł̈ʑ\8A\82̎Z\8Fo
