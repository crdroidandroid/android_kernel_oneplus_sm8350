...
int oplus_display_panel_set_hbm(void *buf)
{
	 ...
	 * crDroid framework incorrectly writes hbm_mode=1 which corrupts
	 * AOD brightness state: the global hbm_mode variable causes
	 * DSI_CMD_AOD_HBM_ON to be sent during fingerprint exit
	 * (oplus_dc_diming.c:839), and makes dim layer alpha return 0
